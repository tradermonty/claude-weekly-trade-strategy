...
// Main composition with optimized timing and high-quality audio
export const AfterMarketSlidesOptimized: React.FC = () => {
	...
	const slideDurations = [
		...
		Math.ceil((10.656 + 1) * fps), // Slide 6: ~350 frames (11.67s)
	];
