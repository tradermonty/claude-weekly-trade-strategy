...
def extract_right_edge_with_marker(image_path: str, right_percentage: int = 25, output_path: str = None) -> str:
    """
...
Examples:
  ...
  python extract_chart_right_edge.py charts/2025-12-22/IMG_5499.jpeg --mark
    ...
    parser.add_argument('--percent', type=int, default=25, help='Percentage of width to extract from right (default: 25)')
    ...
    parser.add_argument('--mark', action='store_true', help='Also create a marked version showing the analysis region')
